...
waiting $delay7 $interval $elapsed


echo
echo "### Step 8 -- Removing the servers $PC_SRV and $SQL_SRV"
if {
...
echo    
echo "### Step 11 -- Listing available images:"
gcloud compute images list --project="$GCP_PROJECT_ID"


echo
echo "### Step 12 -- Creating templates:"
# gcloud compute instance-templates list --project="$GCP_PROJECT_ID"


echo
delay13=900
echo "### Step 13 -- Wait for $delay13 seconds. Press [q] to interrupt."
interval=10
elapsed=0
waiting $delay13 $interval $elapsed


echo
echo "### Step 14 -- Cleaning up the infrastructure:"
if {
